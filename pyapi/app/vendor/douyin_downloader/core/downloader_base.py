...
from app.vendor.douyin_downloader.core.metadata import extract_author_sec_uid
from app.vendor.douyin_downloader.core.transcript_manager import TranscriptManager
from app.vendor.douyin_downloader.storage import Database, FileManager, MetadataHandler
from app.vendor.douyin_downloader.utils.logger import setup_logger
from app.vendor.douyin_downloader.utils.naming import (
    ...
    async def _download_aweme_assets(
        ...
        *,
        ...
        if isinstance(comments_cfg, dict) and comments_cfg.get("enabled"):
            from app.vendor.douyin_downloader.core.comments_collector import CommentsCollector
